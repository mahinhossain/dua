          ...
          {currentMonthTarget ? (
            <>
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="text-blue-600">Collection</h3>
                  <p className="text-2xl font-bold">
                    {collections
                      .filter(
                        (ff) =>
                          ff.month == currentMonthTarget.month &&
                          ff.userId == currentMonthTarget.userId &&
                          ff.year == currentMonthTarget.year
                      )
                      .reduce(
                        (sum, item) => sum + parseInt(item.collection),
                        0
                      )}
                  </p>
                </div>
                ...
                {allTargets.map((target, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* <td className="py-3 px-6 text-sm text-gray-700">
                        {collections.reduce((sum,item)=>sum+parseInt(item.collection) ,0)}
                      </td> */}
                      <td
